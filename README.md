...
The author-approved manuscript is checked in at `docs/MOBRA_Manuscript.pdf` without modification. It is 22 pages, 1,691,010 bytes, and has SHA-256 `8dbcf4e3c1017144fbd0f4fb415398f87f5665d8fce4f106b2a18354aaac22f5`. The manuscript's historical illustrative BRI of 81.0% is explicitly separated from the current demonstration BRI of 86.7%. See [docs/MANUSCRIPT_INTEGRATION.md](docs/MANUSCRIPT_INTEGRATION.md).
...
The full disclaimer appears in the Home page, Resources and Contact, generated HTML reports, PDF/Excel templates, educational posters, backup packages, this README, and `TECHNICAL_REVIEW.md`. Final legal wording should be reviewed by qualified legal counsel before institutional deployment.

## Visual identity, posters, and live QA

Version 0.9.0 adds original MOBRA logo assets, a favicon, a monochrome fallback, an accessible palette, brand guidelines, an information poster, and ten educational poster sets in SVG, PNG, and PDF. The application uses popovers with an expander fallback, once-only contextual notifications, a manuscript card, poster cards, stable template status labels, and branded report/backup outputs. See [docs/VISUAL_IDENTITY.md](docs/VISUAL_IDENTITY.md), [docs/EDUCATIONAL_MEDIA.md](docs/EDUCATIONAL_MEDIA.md), and [docs/LIVE_APPLICATION_QA.md](docs/LIVE_APPLICATION_QA.md).
